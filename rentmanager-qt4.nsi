...
!define QT_DLLS "/opt/mingw32/bin"
!define SYS_LIBS "/opt/mingw32/bin"
!define QT_PLUGINS "/opt/mingw32/lib/qt4/plugins"
#--------------------------------
...
# Create shortcuts
	...
	CreateShortcut "$SMPROGRAMS\$StartMenuFolder\RentManager.lnk" \
		"$INSTDIR\RentManager.exe" "" "$INSTDIR\cottage.ico"
    ...
    WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\RentManager" \
        "DisplayIcon" "$INSTDIR\cottage.ico"
    WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\RentManager" \
