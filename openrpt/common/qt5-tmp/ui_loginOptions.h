...
public:
    ...
    void setupUi(QDialog *loginOptions)
    {
        if (loginOptions->objectName().isEmpty())
            loginOptions->setObjectName(QStringLiteral("loginOptions"));
        ...
        _portLit->setObjectName(QStringLiteral("_portLit"));
        ...
        _driverLit->setObjectName(QStringLiteral("_driverLit"));
        ...
        _driver->setObjectName(QStringLiteral("_driver"));
    ...
    void retranslateUi(QDialog *loginOptions)
    {
        ...
        _driver->insertItems(0, QStringList()
         << QApplication::translate("loginOptions", "PostgreSQL", 0)
         << QApplication::translate("loginOptions", "ODBC", 0)
        );
